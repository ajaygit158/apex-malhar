...
public class WindowedMergeOperatorTest
{
  ...
  public void windowedMergeOperatorWatermarkTest()
  {
    ...
    Assert.assertEquals(1, sink.collectedControlTuples.size());
    ...
    Assert.assertEquals(2, sink.collectedControlTuples.size());
    ...
    Assert.assertEquals(3, sink.collectedControlTuples.size());
