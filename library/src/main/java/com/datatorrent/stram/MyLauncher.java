 ...
 * @since 3.5.0
 */
public abstract class MyLauncher<H extends MyLauncher.AppHandle>
{
   ...
   */
  public static class LaunchMode<L extends MyLauncher>
  {
    /**
     * Launch application in the current Java VM
     */
    public static final LaunchMode<MyEmbeddedAppLauncher> EMBEDDED = new LaunchMode<>(MyEmbeddedAppLauncher.class);
    /**
   ...
   * @return The launcher
   */
  public static <L extends MyLauncher<?>> L getLauncher(LaunchMode<L> launchMode)
  {
    L launcher;
