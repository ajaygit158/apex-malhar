...
public class MyEmbeddedAppLauncherImpl extends MyLocalMode<MyEmbeddedAppLauncherImpl.EmbeddedAppHandleImpl>
{
  ...
  {
    return MyStramLocalCluster.cloneLogicalPlan(lp);
  }
      ...
      launchParameters) throws LauncherException
  {
    ...
    MyStramLocalCluster lc = getController();
  ...
  @Override
  public MyStramLocalCluster getController()
  {
    try {
      addLibraryJarsToClasspath(lp);
      return new MyStramLocalCluster(lp);
    } catch (Exception e) {
  ...
  public static class EmbeddedAppHandleImpl implements MyEmbeddedAppLauncher.EmbeddedAppHandle
  {
    final MyStramLocalCluster controller;

    public EmbeddedAppHandleImpl(MyStramLocalCluster controller)
    {
