 ...
 * @since 3.5.0
 */
public abstract class MyEmbeddedAppLauncher<H extends MyEmbeddedAppLauncher.EmbeddedAppHandle> extends MyLauncher<H>
{
  /**
  ...
  static {
    Attribute.AttributeMap.AttributeInitializer.initialize(MyEmbeddedAppLauncher.class);
  }

  public static MyEmbeddedAppLauncher newInstance()
  {
    return loadService(MyEmbeddedAppLauncher.class);
  }
  ...
  {
    MyEmbeddedAppLauncher launcher = newInstance();
