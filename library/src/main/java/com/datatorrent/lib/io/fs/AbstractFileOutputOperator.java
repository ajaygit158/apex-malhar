...
public abstract class AbstractFileOutputOperator<INPUT> extends BaseOperator implements Operator.CheckpointListener, Operator.CheckpointNotificationListener
{
  ...
  public final transient ControlAwareDefaultInputPort<INPUT> input = new ControlAwareDefaultInputPort<INPUT>()
  {
    ...
    {
      return handleControlTuple(controlTuple);
    }
  };
  ...
  protected RotationState getRotationState(String fileName)
  {
...
/**
  ...
  */
  ...
  public abstract boolean handleControlTuple(ControlTuple controlTuple);
}
